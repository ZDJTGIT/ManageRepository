...
import com.zd.manager.account.model.StatelessToken;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = { "com.zd.manager.*.controller" })
public class Swagger2Config {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("中大管理rest api接口")
				.contact(
						new Contact("智能研究院", "http://localhost",
								"1250368725@qq.com"))
